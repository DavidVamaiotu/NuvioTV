...
- **Auto Sync Tolerance setting.** In Settings › Subtitles, choose a tolerance (100–500 ms). When a confident match would move the subtitle by no more than that, its original timing is kept.
